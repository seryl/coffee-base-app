  ...
  */
  ...
  CLI = (function() {
    ...
    function CLI() {
      ...
      this.argv = optimist.usage("Usage: " + exports.name).alias('c', 'config').describe('c', 'The configuration file to use')["default"]('c', "/etc/baseapp.json").alias('l', 'loglevel').describe('l', 'Set the log level (debug, info, warn, error, fatal)')["default"]('l', 'warn').alias('h', 'help').describe('h', 'Shows this message')["default"]('h', false).argv;
      this.configure();
